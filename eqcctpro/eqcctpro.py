...
# eqcct_runner = EQCCTMSeedRunner(use_gpu=True, # Defines if you use the GPU to run EQCCTMSeedRunner (bool)
...
#                 cpu_test_step_size=5, # Is the desired step size for the trials will march from min_cpu_amount to len(cpu_id_list) (int)
#                 stations2use=2, # Controls the maximum amount of stations EvaluateSystem can use in its trial iterations (int)
